...
@section('content')
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Ajouter içi un nouvelle configuration</div>
	                </div>
...
<select name="type" id="type" class="form-control">
											...
											<option value="DEVELOPER_NAME">Equipe de developpement</option>
  ...
  <circle cx="8" cy="4.5" r="1"/>
                                        ...
                                        placeholder="Entrer la valeur de la configuration" 
                                        name="value" value="{{ old('name') }}"  required>
                                        @error('value')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
									</div>
