...
@section('content')
  ...
  <circle cx="8" cy="4.5" r="1"/>
                                        ...
                                        name="nom"  value="{{ $employer->contact }}"required>
										@error('nom')
											<div class="text-danger">{{ $message }}</div>
										@enderror
									</div>
								    ...
								    <div class="mb-3">
									    ...
									    <input type="email" class="form-control" id="setting-input-3" placeholder="Entrer l'email " name="email" value="{{ $employer->email }}" required>
										@error('email')
											<div class="text-danger">{{ $message }}</div>
										@enderror
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="number" class="form-control" id="setting-input-3" placeholder="Entrer le contact " name="contact"  value="{{ $employer->contact }}"required>
										@error('contact')
											<div class="text-danger">{{ $message }}</div>
										@enderror
									</div>
									<div class="mb-3">
									    ...
									    <input type="number" class="form-control" id="setting-input-3" placeholder="Entrer le montant journalier  " name="montant_journalier" value="{{ $employer->montant_journalier }}" required>
