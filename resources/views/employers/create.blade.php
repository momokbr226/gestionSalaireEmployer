...
@section('content')
  ...
  <circle cx="8" cy="4.5" r="1"/>
								    ...
								    <div class="mb-3">
									    ...
									    <input type="email" class="form-control" id="setting-input-3" placeholder="Entrer l'email " name="email" required>
									</div>
                                   
                                    <div class="mb-3">
									    <label for="setting-input-3" class="form-label">Contact </label>
									    <input type="text" class="form-control" id="setting-input-3" placeholder="Entrer le contact " name="contact" required>
									</div>
